                ...
                for(Node nodeInTitlePane : block.getTitlePane().getChildren()){
                    if(nodeInTitlePane instanceof StackPane){
                        ...
                        if(stackPane.getChildren().size()>1){
                            ...
                            if(stackPane.getChildren().get(0) instanceof TextField && ((TextField)stackPane.getChildren().get(0)).editableProperty().getValue())
                                list.add(stackPane);
                            else if(stackPane.getChildren().get(0) instanceof ComboBox)
                                list.add(stackPane);
                        }
                    }
                }
...
//        System.out.println(this + " " + mouseEvent.getTarget());
        ...
        if(currentStackPanes==null)return;
